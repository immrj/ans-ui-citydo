    ...
    <div
        ...
        <transition name="transition-drop">
            <x-drop
                ...
                :transfer="transfer"
                v-transfer-dom><slot name="list"></slot></x-drop>
        </transition>
    </div>
</template>
<script>
import xDrop from './drop'
import { LIB_NAME, oneOf, findComponentUpward, transferDom, clickOutside } from '../../../../src/util'

const prefixCls = `${LIB_NAME}-dropdown`
