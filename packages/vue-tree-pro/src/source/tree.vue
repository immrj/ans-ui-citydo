<template>
  ...
  >
    ...
    <div :class="prefixCls + '-context-menu'" :style="contextMenuStyles">
      <x-dropdown trigger="custom" :visible="contextMenuVisible" transfer
...
<script>
  ...
  export default {
    ...
    components: {
      TreeNode, xDropdown, xDropdownMenu
    },
    ...
    created () {
      ...
      this.$on('tree-node-drag-over', (event, treeNode) => {
        ...
        const iconPosition = dropNode.$el.querySelector(`.${this.prefixCls}-node__expand-icon`).getBoundingClientRect()
