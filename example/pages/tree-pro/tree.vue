<template>
  <div>
    <section class="demo-section">
      ...
      <div>
        <x-tree-pro :data="data1"></x-tree-pro>
      </div>
    </section>
    <section class="demo-section">
      <h4>可勾选</h4>
      ...
      <div>
        <x-tree-pro :data="data2" show-checkbox></x-tree-pro>
      </div>
    </section>
    <section class="demo-section">
      <h4>点击标题展开节点</h4>
      ...
      <div>
        <x-tree-pro :data="data1" expand-node></x-tree-pro>
      </div>
    </section>
    <section class="demo-section">
      <h4>异步加载子节点</h4>
      ...
      <div>
        <x-tree-pro :data="data3" :load="loadData" show-checkbox></x-tree-pro>
      </div>
    </section>
    <section class="demo-section">
      <h4>自定义节点内容 </h4>
      ...
      <div>
        <x-tree-pro :data="data5" :render-content="renderContent" class="demo-tree-render"></x-tree-pro>
      </div>
    </section>
    <section class="demo-section">
      <h4>右键菜单</h4>
      ...
      <div>
        <x-tree-pro :data="data6" @node-contextmenu="handleContextMenu">
